...
switch(educationlevel)
{
    ...
    case "kindergarden": System.Console.WriteLine("1)Qorako'lziyo nur from Tashkent city 2 branch,\n courses "
    +"1*Mathematic"
    +"2*Physics"
    +"3*Biology"
    ...
    switch(course)
    {
          case 1:System.Console.WriteLine("Mathematic 650,000 sum Lessons are conducted by experienced teachers");
          break;
          case 2:System.Console.WriteLine("Ietszone education Every student's result is important to us"
   ...
   case " school":System.Console.WriteLine("1)Qorako'lziyo nur from Tashkent city 2 branch,\n courses "
    +"1*Mathematic"
    +"2*Physics"
    +"3*Biology"
    +"Creative student education \n 2)Ietszone english education 1)Amir Temur street,2)Near Chilanzor metro");  
    ...
    case "univercity": System.Console.WriteLine("1)Qorako'lziyo nur from Tashkent city 2 branch,\n courses "
    +"1*Mathematic"
    +"2*Physics"
    +"3*Biology"
    +"Creative student education \n 2)Ietszone english education 1)Amir Temur street,2)Near Chilanzor metro");  
